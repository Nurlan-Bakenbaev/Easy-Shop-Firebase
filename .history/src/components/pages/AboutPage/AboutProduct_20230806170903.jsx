...
const AboutProduct = () => {
  ...
  if (aboutData === null) {
    return <div className="pre__loading">
      <Loader/>
    </div>;
  }
  return (
    <>
      ...
      <div className="aboutGrid">
        <div className="item__Informaton"><h1>Описание и характеристики</h1>
          <ul>

        {aboutData.description ?  aboutData.description.map(item=>
          <li key={item.id}>{item}</li>): <p>НЕТ ДАННЫХ</p> }
          </ul>
        </div>
