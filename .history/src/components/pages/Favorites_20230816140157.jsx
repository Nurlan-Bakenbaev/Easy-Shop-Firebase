...
const Favorites = ({ favorite, handleClick, handleFavorite,link }) => {
  return (
    <div className="favorite">
      <img ые src="https://firebasestorage.googleapis.com/v0/b/kleinerladen-6644f.appspot.com/o/edit-removebg-preview.png?alt=media&token=dfc5c539-60d1-43c9-9300-42576d0fa1d2" alt="Избранное" />
