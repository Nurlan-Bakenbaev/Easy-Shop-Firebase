...
const Favorites = ({ favorite, handleClick, handleFavorite }) => {
  if(favorite.length===0){
    return <img style={{width:'40wh',height:'40vh'}} src="https://firebasestorage.googleapis.com/v0/b/kleinerladen-6644f.appspot.com/o/edit-removebg-preview.png?alt=media&token=dfc5c539-60d1-43c9-9300-42576d0fa1d2" alt="Избранное" />
