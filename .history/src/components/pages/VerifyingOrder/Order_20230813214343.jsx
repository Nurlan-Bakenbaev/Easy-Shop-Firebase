...
const OrderForm = (
    ...
    <form>
      ...
      <div className="order__grid">
        <div className="order-form">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93561.93331260461!2d74.50945972543877!3d42.8768455045181!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x389eb7dc91b3c881%3A0x492ebaf57cdee27d!2z0JHQuNGI0LrQtdC6LCDQmtGL0YDQs9GL0LfRgdGC0LDQvQ!5e0!3m2!1sru!2sde!4v1690235986628!5m2!1sru!2sde"></iframe>
          <div className="form">
    ...
    <div className="cost__items">
          ...
          {cartItem.map((el)=>{
            return(
              <ul key={el.id}>
            <li>
              {el.title} <span>$ {el.price } x { el.total}</span>
            </li>
            <li>
          ...
          <button onClick={()=>ShowReadyOrder()} className="form__submit-btn">Закончить оформление</button>
        </div>
  </div>
);
  ...
  return(
  <>
  {isSubmitForm ? <ReadyOrder/> : OrderForm}
  </>)
};
