...
const Order = ({ cartItem }) => {
  ...
  const orderNumm = Math.round(Math.random()*1000000);
  ...
  return (
    <>
      {isSubmitForm ? (
        <p style={{margin:'50px',textAlign:'center'}}value={formData.orderNumber} name='orderNumber'>Ваш номер заказа {orderNumm} наш менеджер с вами свяжется </p>
      ) : (
        OrderForm
      )}
    </>
