...
const Order = ({ cartItem }) => {
  ...
  const totalCost = cartItem.reduce((total, item) => total + item.price * item.total, 0);
    ...
    <div className="order-wrapper">
      ...
      <form className="order" onSubmit={handleSubmitForm}>
        <div>
          <div className="order-form">
            ...
            <div>
              ...
              <p>Доставка курьером</p> <span>(1% от суммы заказа)</span>
            </div>
            <div className="form">
        ...
        <div className="cost__items">
          ...
          <p> Доставка по городу : $ {  Math.floor(( totalCost /100) *1)}</p>
