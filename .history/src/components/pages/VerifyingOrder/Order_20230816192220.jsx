...
const Order = ({ cartItem }) => {
  ...
  return (
    <>
      {isSubmitForm ? (
        <div>
          <img st src="https://firebasestorage.googleapis.com/v0/b/kleinerladen-6644f.appspot.com/o/readycargo.png?alt=media&token=56693ffa-c0dc-4c78-a672-f04772ec645b" alt='Доставка' />
