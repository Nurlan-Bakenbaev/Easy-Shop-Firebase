...
const Order = ({ cartItem }) => {
    ...
    <div className="order_page">
      ...
      <form className="order" onSubmit={handleSubmitForm}>
        ...
        <div className="cost__items">
          ...
          <h3>Полная стоимость:$ {totalCost}</h3>
          <p>
            {" "}
            Доставка по городу : ${" "}
  ...
  return (
    <>
      {isSubmitForm ? (
        <div>
          <img style={{width:'100%',}} src="https://firebasestorage.googleapis.com/v0/b/kleinerladen-6644f.appspot.com/o/readycargo.png?alt=media&token=56693ffa-c0dc-4c78-a672-f04772ec645b" alt='Доставка' />
          <p style={{ margin: "", textAlign: "center" }}>
            Ваш номер заказа{" "}
