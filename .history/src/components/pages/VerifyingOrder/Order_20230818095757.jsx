    ...
    <div className="order_page">
      ...
      <form className="order" onSubmit={handleSubmitForm}>
        <div>
          <div className="order-form">
            ...
            <div className="form">
              ...
              <p onClick={() => resetForm()} className="clearForm">
                Clear Form
              </p>
            </div>
          </div>
        ...
        <div className="cost__items">
          ...
          <button className="form__submit-btn">Purchase</button>
        </div>
      </form>
    </div>
  );
    ...
    <>
      {isSubmitForm ? (
        ...
        >
          <img
            style={{ maxWidth: "100%" }}
            src="https://firebasestorage.googleapis.com/v0/b/kleinerladen-6644f.appspot.com/o/readycargo.png?alt=media&token=56693ffa-c0dc-4c78-a672-f04772ec645b"
            alt="Доставка"
          />
